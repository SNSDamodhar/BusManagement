<?php
    ...
    $students_query = "SELECT * FROM students WHERE student_bus = 'NO BUS'";
...
<body style="background: linear-gradient(to right, #9796f0 -20%, #fbc7d4 100%);">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse w-100 order-3 dual-collapse2" id="navbarNavAltMarkup">
                 <ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<a class="nav-item nav-link" href="./index.php" style="color:white; margin-left: 20px; margin-right: 20px;">Home</a>
					</li>
    ...
    <div class="container" style="margin-top: 50px;">
			<h3 style="text-align: center; margin-bottom: 60px;">List Of Students</h3>
						...
						<tr>
							...
							<td>
								<form action="./deleteUsers.php" method="post" onsubmit = "return deleteValidate()">
									<input type="hidden" name="id" value = "<?php echo $row[1] ?>">
									<input type="hidden" name="user" value = "student_no_bus">
